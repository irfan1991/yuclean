c{!! Form::open(['url' => '/checkout/payment', 'method'=>'post', 'class' => 'form-horizontal']) !!}
    ...
    <div class="form-group">
        <div class="col-md-6 col-md-offset-4">
            {!! Form::button('<i class="fa fa-lock"></i> Konfirmasi Pesanan', array('type' => 'submit', 'class' => 'btn-primary')) !!}
        </div>
    </div>
{!! Form::close() !!}
