 ...
 <style>
  ...
  @if ($cart->isEmpty())
    <div class="text-center" align="text-center">
      ...
      <p><a href="{{ url('/cata') }}">Lihat Semua Barang <span class=" glyphicon glyphicon-triangle-right"></span></a></p>
    </div>
  @else
    <table class="cart table table-hover table-condensed " align="text-center">
      <thead>
        <tr>
          <th style="width:30%" align="center">Barang</th>
      ...
      <tbody>
        ...
        <tr>
          <td data-th="Barang" align="center">
            <div class="row">
              <div class="col-sm-4"><img src="{{ $order['detail']['photo_path'] }}" alt="gambar tidak ada" class="img-responsive" style=" width:100%;height:100%" /></div>
              <div class="col-sm-10">
          ...
          <td data-th="Jumlah">
            {!! Form::open(['url' => ['carti', $order['id']], 'method'=>'put', 'class' => 'form-inline' ]) !!}
          ...
          <td class="actions" data-th="">
            ...
            {!! Form::open(['url' => ['carti', $order['id']], 'method'=>'delete', 'class' => 'form-inline']) !!}
      ...
      <tfoot>
        ...
        <tr>
         <td align="center"><a href="{{ url('/cata') }}" class=" btn-warning"><span class="glyphicon glyphicon-triangle-left"></span> Belanja lagi</a></td>
          <td colspan="2" class="hidden-xs"></td>
          <td class="hidden-xs text-center"><strong>Total Rp{{ number_format($cart->totalPrice()) }}</strong></td>
          <td align="center"><a href="{{ url('/checkout/logini') }}" class=" btn-success">Pembayaran <span class="glyphicon glyphicon-triangle-right"></span></a></td>
        </tr>
      </tfoot>
    </table>
  @endif
