...
@section('content')
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <h3>Data Nasabah </h3>
        {!! Form::open(['url' => 'timbang', 'method'=>'get', 'class'=>'form-inline pull-right']) !!}
            <div class="form-group ">
            {!! Form::text('q', isset($q) ? $q : null, ['class'=>' typeahead form-control','placeholder' => 'Nama Nasabah..','style'=>'width:300px;', 'id'=>'coba','autocomplete'=>'off'] ) !!}
