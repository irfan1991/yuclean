            ...
            <div class="row">
                <div class="grid_12">
                    ...
                    <nav class="nav put-right">
                        ...
                        @endrole
                            <li class="dropdown" >
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Fitur</a> 
                            ...
                            <li class="dropdown" >
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Daftar</a> 
                             <ul class="dropdown-menu" role="menu">
...
<a href="#" class="  dropdown-toggle user-profile" data-toggle="dropdown" role="button" aria-expanded="false"> <img src="{{ URL::to('/') }}/images/user/{{ Auth::user()->image }}" alt=""> Halo, 
                ...
                @endif
                            ...
                            <li class="dropdown" >
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">Lokasi</a> 
                              <ul class="dropdown-menu" role="menu">
